      ...
      <div className="container lg:flex">
        <div className="max-w-[25rem]">
          <h2 className="h2 font-open mb-4 md:mb-8">
            Disseny web adaptat al que necessites
          </h2>
          <ul className="max-w-[22rem] mb-10 md:mb-14">
            {collabContent.map((item) => (
              <li className="mb-3 py-3" key={item.id}>
                ...
                {item.text && (
                  <p className=" font-mon body-2 mt-3 text-n-4">{item.text}</p>
                )}
              </li>
            ))}
          </ul>
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
          <p className="body-2 font-mon mb-8 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto">
            {collabText}
          </p>
